...
set @openResult_Description         = 'Remote Data Archive feature must be disabled, unless specifically required and approved.'
set @notafinding_ResultDescription  = 'Remote Data Archive feature is currently disabled.'
