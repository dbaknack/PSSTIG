...
set @openResult_Description         = 'SQL Server User Options feature must be disabled, unless specifically required and approved.'
set @notafinding_ResultDescription  = 'SQL Server User Options feature is currently disabled.'
