...
set @openResult_Description         = 'Allow Polybase Export feature must be disabled, unless specifically required and approved.'
set @notafinding_ResultDescription  = 'Polybase Export feature is currently disabled.'
