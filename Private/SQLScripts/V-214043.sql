...
set @openResult_Description = 'System documentation needs to be reviewed to determine the use of Replication Xps is required AND authorized.'
set @notafinding_ResultDescription = 'Replication Xps is currently disabled.'
