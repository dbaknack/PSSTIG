...
set @openResult_Description         = 'Filestream must be disabled, unless specifically required and approved.'
set @notafinding_ResultDescription  = 'Filestream must be disabled is currently disabled.'
